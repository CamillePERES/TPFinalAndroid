...
class AddNeighbourFragment(private val handler: ListNeighborHandler, private val listener: NavigationListener, private val neighbor: Neighbor?) : Fragment() {
    ...
    private val model: NeighborDTO = if(neighbor == null) NeighborDTO("", "", "", "", "", "", false, null)
                                     else NeighborDTO(neighbor.name, neighbor.avatarUrl, neighbor.address, neighbor.phoneNumber, neighbor.aboutMe, neighbor.webSite, neighbor.favorite, neighbor.id)
